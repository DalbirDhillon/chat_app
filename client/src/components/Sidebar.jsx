...
const SideBar = () => {
  ...
  return (
    <div className={`bg-[#8185B2]/10 h-full p-4 rounded-r-xl overflow-y-scroll text-white
    ${setSelectedUser ? "max-md:hidden" : ''}`}>
      <div className='pb-5'>
        ...
        <div className='bg-[#282142] rounded-full flex items-center gap-2 py-1 px-4 mt-5'>
            <img src={assets.search_icon} alt="Search" className='w-5 h-5 object-contain' />
            <input onChange={(e)=>setInput(e.target.value)}
            type='text' className='bg-transparent border-none outline-none text-white 
